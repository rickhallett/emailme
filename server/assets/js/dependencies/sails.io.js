            ...
            function d(a, b) {
              ...
              (b = b || {}),
                ...
                a
                  ...
                  : b.host && (b.hostname = k(b.host).host),
                (this.secure =
                  null != b.secure
                    ? b.secure
                    : c.location && "https:" == location.protocol),
                b.hostname && !b.port && (b.port = this.secure ? "443" : "80"),
                (this.agent = b.agent || !1),
                (this.hostname =
                  b.hostname || (c.location ? location.hostname : "localhost")),
                (this.port =
                  b.port ||
                  (c.location && location.port
                    ? location.port
                    : this.secure
                    ? 443
                    : 80)),
                ...
                (this.perMessageDeflate =
                  !1 !== b.perMessageDeflate ? b.perMessageDeflate || {} : !1),
                ...
                (this.rejectUnauthorized =
                  void 0 === b.rejectUnauthorized
                    ? null
                    : b.rejectUnauthorized);
              var e = "object" == typeof c && c;
              e.global === e &&
                b.extraHeaders &&
                Object.keys(b.extraHeaders).length > 0 &&
            ...
            g(e, f),
              ...
              (e.prototype.doWrite = function (a, b) {
                ...
                function d() {
                  ...
                  try {
                    var b =
                      '<iframe src="javascript:0" name="' + e.iframeId + '">';
          ...
          (function (c) {
            ...
            (b.exports = e),
                    ...
                    if (this.extraHeaders) {
                      ...
                      for (var e in this.extraHeaders)
                        this.extraHeaders.hasOwnProperty(e) &&
                          b.setRequestHeader(e, this.extraHeaders[e]);
                    }
                  } catch (g) {}
                  if (
              ...
              (f.prototype.hasXDR = function () {
                return (
                  "undefined" != typeof c.XDomainRequest &&
                  !this.xs &&
                  this.enablesXDR
                );
              }),
              ...
              c.document &&
                ...
                (f.requests = {}),
                c.attachEvent
                  ? c.attachEvent("onunload", g)
                  : c.addEventListener &&
                    c.addEventListener("beforeunload", g, !1));
          }.call(
            this,
            "undefined" != typeof self
              ? self
          ...
          h(d, e),
            ...
            (d.prototype.doClose = function () {
              ...
              "open" == this.readyState
                ...
                : (j("transport not open - deferring close"),
                  this.once("open", a));
            }),
        ...
        function (a, b, c) {
          (function (c) {
            ...
            var e = a("../transport"),
              ...
              l = k || ("undefined" != typeof window ? null : a("ws"));
            (b.exports = d),
              h(d, e),
              ...
              (d.prototype.write = function (a) {
                ...
                var d = this;
                this.writable = !1;
                for (var e = a.length, g = 0, h = e; h > g; g++)
                  !(function (a) {
                    f.encodePacket(a, d.supportsBinary, function (f) {
                      if (!k) {
                        ...
                        if (
                          ...
                          var h =
                            "string" == typeof f
                              ? c.Buffer.byteLength(f)
                              : f.length;
                          h < d.perMessageDeflate.threshold &&
                            (g.compress = !1);
                        }
                      }
                      try {
              ...
              (d.prototype.check = function () {
                return !(
                  !l ||
                  ("__initialize" in l && this.name === d.prototype.name)
                );
              });
          }.call(
            this,
      ...
      18: [
        function (a, b, c) {
          ...
          function e(a) {
            ...
            function e() {
              ...
              (g[0] = g[0].replace(/%([a-z%])/g, function (b, d) {
                ...
                "function" == typeof c.formatArgs &&
                  (g = c.formatArgs.apply(a, g));
          ...
          function f(a) {
            c.save(a);
            for (
              var b = (a || "").split(/[\s,]+/), d = b.length, e = 0;
              d > e;
              e++
            )
              b[e] &&
                ((a = b[e].replace(/\*/g, ".*?")),
                "-" === a[0]
                  ? c.skips.push(new RegExp("^" + a.substr(1) + "$"))
                  : c.names.push(new RegExp("^" + a + "$")));
          }
          function g() {
            c.enable("");
          }
        ...
        function (a, b, c) {
          (function (b) {
            ...
            var r = (c.packets = {
              ...
              s = i(r),
              t = { type: "error", data: "parser error" },
              u = a("blob");
            (c.encodePacket = function (a, c, f, h) {
              ...
              return (
                void 0 !== a.data &&
                  (j += f ? n.encode(String(a.data)) : String(a.data)),
                h("" + j)
              );
            }),
              ...
              (c.decodePacket = function (a, b, d) {
                if ("string" == typeof a || void 0 === a) {
                  ...
                  var f = a.charAt(0);
                  return Number(f) == f && s[f]
                    ? a.length > 1
                      ? { type: s[f], data: a.substring(1) }
                      : { type: s[f] }
                    : t;
                }
                var g = new Uint8Array(a),
                  ...
                  h = k(a, 1);
                return (
                  u && "blob" === b && (h = new u([h])), { type: s[f], data: h }
                );
              }),
              (c.decodeBase64Packet = function (a, c) {
                var d = s[a.charAt(0)];
                if (!b.ArrayBuffer)
                  return { type: d, data: { base64: !0, data: a.substr(1) } };
                var e = l.decode(a.substr(1));
                return (
                  "blob" === c && u && (e = new u([e])), { type: d, data: e }
                );
              }),
              (c.encodePayload = function (a, b, d) {
                ...
                return b && g
                  ? u && !q
                    ? c.encodePayloadAsBlob(a, d)
                    : c.encodePayloadAsArrayBuffer(a, d)
                  : a.length
                  ? void h(a, f, function (a, b) {
                      return d(b.join(""));
                    })
                  : d("0:");
              }),
              ...
              (c.encodePayloadAsArrayBuffer = function (a, b) {
                ...
                return a.length
                  ? void h(a, d, function (a, c) {
                      var d = c.reduce(function (a, b) {
                          var c;
                          return (
                            (c =
                              "string" == typeof b ? b.length : b.byteLength),
              ...
              (c.decodePayloadAsBinary = function (a, b, d) {
                ...
                for (var e = a, f = [], g = !1; e.byteLength > 0; ) {
                  for (
                    var h = new Uint8Array(e), i = 0 === h[0], j = "", l = 1;
                    255 != h[l];
                    l++
                  ) {
                    if (j.length > 310) {
          ...
          (function (c) {
            function d(a) {
              function b(a) {
                if (!a) return !1;
                if (
                  (c.Buffer && c.Buffer.isBuffer(a)) ||
                  (c.ArrayBuffer && a instanceof ArrayBuffer) ||
                  (c.Blob && a instanceof Blob) ||
                  (c.File && a instanceof File)
                )
                  return !0;
                if (e(a)) {
          ...
          (function (a) {
            ...
            b.exports = function (b) {
              return "string" == typeof b && b
                ? ((b = b.replace(g, "").replace(h, "")),
                  a.JSON && JSON.parse
                    ? JSON.parse(b)
                    : c.test(b.replace(d, "@").replace(e, "]").replace(f, ""))
      ...
      27: [
        function (a, b, c) {
          (c.encode = function (a) {
            ...
            (c.decode = function (a) {
              for (
                var b = {}, c = a.split("&"), d = 0, e = c.length;
                e > d;
                d++
              ) {
                var f = c[d].split("=");
          ...
          (function (b) {
            !(function (e) {
              ...
              var r,
                ...
                v = { version: "2.0.0", encode: k, decode: n };
        ...
        function (a, b, c) {
          function d(a, b) {
            ...
            var c,
              ...
              m =
                b.forceNew ||
                b["force new connection"] ||
                !1 === b.multiplex ||
                l;
            return (
              m
                ? (h("ignoring socket cache for %s", f), (c = g(f, b)))
                : (i[j] || (h("new io instance for %s", f), (i[j] = g(f, b))),
                  (c = i[j])),
              c.socket(d.path)
            );
          }
          ...
          (b.exports = d),
            ...
            (d.prototype.onopen = function () {
              ...
              this.subs.push(i(a, "data", j(this, "ondata"))),
                ...
                this.subs.push(
                  i(this.decoder, "decoded", j(this, "ondecoded"))
                );
            }),
          ...
          f(d.prototype),
            (d.prototype.subEvents = function () {
              if (!this.subs) {
                var a = this.io;
                this.subs = [
                  h(a, "open", i(this, "onopen")),
                  h(a, "packet", i(this, "onpacket")),
                  h(a, "close", i(this, "onclose")),
                ];
              }
            }),
            ...
            (d.prototype.emit = function (a) {
              ...
              return (
                ...
                "function" == typeof b[b.length - 1] &&
                  (j("emitting packet with ack id %d", this.ids),
            ...
            (d.prototype.onevent = function (a) {
              ...
              j("emitting event %j", b),
                null != a.id &&
                  (j("attaching ack callback to event"),
            ...
            (d.prototype.emitBuffered = function () {
              ...
              for (
                this.receiveBuffer = [], a = 0;
                a < this.sendBuffer.length;
                a++
              )
            ...
            (d.prototype.close = d.prototype.disconnect = function () {
              return (
                this.connected &&
                  (j("performing disconnect (%s)", this.nsp),
                  this.packet({ type: e.DISCONNECT })),
                this.destroy(),
          ...
          (function (c) {
            function d(a) {
              function b(a) {
                if (!a) return !1;
                if (
                  (c.Buffer && c.Buffer.isBuffer && c.Buffer.isBuffer(a)) ||
                  (c.ArrayBuffer && a instanceof ArrayBuffer) ||
                  (c.Blob && a instanceof Blob) ||
                  (c.File && a instanceof File)
                )
            ...
            (c.deconstructPacket = function (a) {
              ...
              (c.removeBlobs = function (a, c) {
                function f(a, i, j) {
                  if (!a) return a;
                  if (
                    (b.Blob && a instanceof Blob) ||
                    (b.File && a instanceof File)
                  ) {
                    g++;
        ...
        function (a, b, c) {
          ...
          (c.protocol = 4),
            ...
            (g.prototype.add = function (a) {
              ...
              if ("string" == typeof a)
                (b = h(a)),
                  c.BINARY_EVENT == b.type || c.BINARY_ACK == b.type
      ...
      48: [
        function (a, b, c) {
          (function (a) {
            function c(b) {
              return (
                (a.Buffer && a.Buffer.isBuffer(b)) ||
                (a.ArrayBuffer && b instanceof ArrayBuffer)
              );
            }
            b.exports = c;
          }.call(
          ...
          (function (b) {
            (function () {
              function e(a, b) {
                ...
                "object" == typeof n &&
                  n &&
                  ((b.stringify = n.stringify), (b.parse = n.parse));
                var o,
                  p,
                  q,
                  r = h.prototype,
                              ...
                              if (
                                ...
                                if (46 == f.charCodeAt(L)) {
                                  for (
                                    c = ++L;
                                    g > c &&
                                    ((e = f.charCodeAt(c)), e >= 48 && 57 >= e);
                                    c++
                                  );
                                  c == L && P(), (L = c);
                                }
                                if (
                                  ((e = f.charCodeAt(L)), 101 == e || 69 == e)
                                ) {
                                  for (
                                    e = f.charCodeAt(++L),
                                      (43 == e || 45 == e) && L++,
...
(function () {
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    SailsSocket.prototype._connect = function () {
      ...
      if (self.initialConnectionHeaders && SDK_INFO.platform !== "node") {
        if (typeof console === "object" && typeof console.warn === "function") {
          console.warn(
            "initialConnectionHeaders option available in Node.js only!"
          );
        }
      }
    ...
    io.sails = {
      ...
      //
      environment: urlThisScriptWasFetchedFrom.match(
        /(\#production|\.min\.js)/g
      )
        ? "production"
        : "development",
